...
import { Calendar, Briefcase, GraduationCap, Award, ChevronRight } from 'lucide-react';
            ...
            <div className="lg:col-span-5 space-y-12">
              {education && (
                <div className="sticky top-32">
                  ...
                  <div className="p-8 rounded-3xl bg-secondary/10 border border-primary/5 shadow-xl shadow-black/5 relative overflow-hidden group">
